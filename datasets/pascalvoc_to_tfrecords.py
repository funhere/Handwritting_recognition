...
def _process_image(directory, name):
    ...
    #image_data = tf.placeholder(dtype=tf.uint8, shape=shape)
...
def run(dataset_dir, output_dir, name='ocr_train', shuffling=False):
    ...
    em = next(tf.python_io.tf_record_iterator("./data/ocr/ocr_train_000.tfrecord"))
